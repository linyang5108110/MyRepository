...
import com.shopping.core.pojo.address.Areas;
import com.shopping.core.pojo.address.AreasQuery;
...
public interface AreasDao {
    ...
    List<Areas> selectByExampleWithRowbounds(AreasQuery example, RowBounds rowBounds);
